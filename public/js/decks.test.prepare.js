(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["decks.test.prepare"],{
      ...
      _c(
        ...
        [
          _c(
            ...
            {
              staticClass:
                "transition duration-200 transform bg-primary hover:bg-red-500 rounded-full h-12 w-12 flex justify-center items-center text-white shadow-lg hover:scale-110",
              on: {
                click: function($event) {
          ...
          _c(
            ...
            {
              staticClass:
                "bg-primary hover:bg-green-500 rounded-full px-4 py-2 font-serif uppercase text-lg w-auto text-white",
    ...
    _c(
      ...
      [
        ...
        _c(
          ...
          {
            staticClass:
              "flex w-full mt-4 py-3 px-4 rounded-lg button-primary items-center",
            on: {
              click: function($event) {
