            ...
            <div class="container sm:mx-auto px-4 py-8 flex">
                <div class="w-1/4">
                    <ul class="mr-4">
                        ...
                        <li class="mb-1"><a href="#formats" class="block p-2 px-4 bg-white hover:bg-orange-500 hover:text-white">Formats</a></li>
                        <li class="mb-1"><a href="#throttling" class="block p-2 px-4 bg-white hover:bg-orange-500 hover:text-white">Throttling</a></li>
                        <li class="mt-4 mb-2"><h2 class="text-xl font-serif uppercase">Endpoints</h2></li>
                        <li class="mb-1"><a href="#cards" class="block p-2 px-4 bg-white hover:bg-orange-500 hover:text-white">Cards</a></li>
