<template>
    <div class="relative font-serif mr-4">
        <button class="relative text-left bg-white border-2 border-gray-200 text-gray-800 text-base font-serif rounded-lg px-4 py-2 uppercase z-75 hover:border-gray-800 flex" @click="isOpen = !isOpen" :class="{ 'border-gray-800': isOpen }" style="width: 150px">
        ...
        <div class="w-full absolute right-0 rounded-lg bg-white z-100 overflow-hidden mt-2 border-2 border-gray-800" v-if="isOpen">
