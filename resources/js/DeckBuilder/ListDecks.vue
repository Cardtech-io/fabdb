    ...
    <div>
        ...
        <div class="bg-white dark:bg-gray-800 border-b-4 border-gray-300 dark:border-gray-600">
            <div class="container sm:mx-auto">
                <form class="p-4 block sm:flex w-full" @submit.prevent="newSearch">
                ...
                <div class="container sm:mx-auto px-4">
                    <div v-if="user">
                        <table class="w-full table-auto border-collapse bg-white dark:bg-gray-800">
                            <thead>
                                <tr class="text-sm">
                                    <th class="p-2 font-serif uppercase text-left font-normal">Deck</th>
                                    <th class="p-2 font-serif uppercase text-left font-normal">Version</th>
                                    <th class="p-2 font-serif uppercase text-left font-normal hidden lg:table-cell">Label</th>
                                    <th class="p-2 font-serif uppercase text-left font-normal hidden lg:table-cell">Parent</th>
                                    <th class="p-2 font-serif uppercase text-left font-normal hidden sm:table-cell">Class</th>
                                    <th class="p-2 font-serif uppercase text-left font-normal hidden md:table-cell">Cards</th>
                                    <th class="p-2 font-serif uppercase text-left font-normal hidden sm:table-cell">Updated</th>
                                    <th class="p-2 font-serif uppercase text-left">Actions</th>
                                </tr>
                            </thead>
                            <tbody>
