<template>
    <div class="py-4 pb-20 flex">
        ...
        <div class="w-1/4 mx-4">
            ...
            <ol class="mt-4">
                <stat :value="totalCards" text="Total" position="top"></stat>
                <stat :value="totalActions" text="Total actions" position="bottom"></stat>
        ...
        <div class="w-1/4 mx-4">
            ...
            <ol class="mt-4">
                ...
                <stat :value="costCount(3)" text="Cost 3+"></stat>
            </ol>
        </div>
