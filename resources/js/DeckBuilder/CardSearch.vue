<template>
    <div>
        ...
        <input type="text" ref="nameSearch" v-model="params.keywords" placeholder="Search..." class="flex-1 bg-transparent outline-none py-1 px-4 lg:text-gray-200" @keyup="delayedSearch" @keyup.enter="finishSearch">
