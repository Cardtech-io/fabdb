<template>
    <div>
        <input type="text" ref="nameSearch" v-model="keywords" placeholder="Search" class="flex-1 bg-transparent outline-none py-3 px-4" @keyup="delayedSearch" @keyup.enter="finishSearch">
