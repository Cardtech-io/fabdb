<template>
    <div>
        <div class="w-full h-full fixed top-0 left-0 z-10 bg-black opacity-50" v-if="visible"></div>
        <div class="fixed w-full z-20" v-if="visible">
            <div class="relative p-8 mt-40 bg-white md:rounded-lg md:w-1/2 md:mx-auto">
                ...
                <h1 class="font-serif text-xl uppercase">Login</h1>

                <div v-if="!submitted">
                    <form @submit.prevent="submitEmail()">
                        <p class="my-4">Some features on FaB DB require an account. Registration/login is super, super easy! Just provide your email and grab the code sent to you in a few moments :)</p>
