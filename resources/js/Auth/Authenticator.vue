<template>
    <div>
        ...
        <div class="modal w-1/2 z-20 p-8" v-if="visible">
            ...
            <div v-if="!submitted">
                ...
                <div class="flex mt-8">
                    <input type="email" class="w-3/4 p-4 rounded-l-lg" placeholder="Email address" v-model="email">
                    <input type="button" class="w-1/4 p-4 rounded-r-lg text-gray-300 bg-gray-800 hover:bg-gray-700" value="Send code" @click="submitEmail()">
                </div>
            </div>
            <div v-else>
                ...
                <div class="flex mt-8">
                    <input type="text" class="w-3/4 p-4 rounded-l-lg" placeholder="" v-model="code">
                    <input type="button" class="w-1/4 p-4 rounded-r-lg text-gray-300 bg-gray-800 hover:bg-gray-700 text-center" value="Login" @click="submitCode()">
                </div>
            </div>
        </div>
    </div>
