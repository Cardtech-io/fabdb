                ...
                <div class="flow-root">
                    ...
                    <div class="md:w-3/4 md:float-right sm:px-4 md:flex">
                        ...
                        <div class="md:w-1/2 md:ml-8">
                            <a :href="buyLink(card)" class="flex w-1/2 items-center bg-gray-50 hover:bg-white border border-gray-400 hover:border-black rounded p-2 py-1 mb-4" target="_blank">
                                <icon :size="6">
