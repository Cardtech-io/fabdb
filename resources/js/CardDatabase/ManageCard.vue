<template>
    <div class="my-4 flex items-center" :class="view == 'list' ? 'justify-center' : ''">
        <button class="flex bg-gray-900 p-2 px-4 h-10 items-center rounded-lg hover:bg-gray-800" @click="add('standard')">
        ...
        <button class="flex bg-gray-900 p-2 px-4 ml-4 h-10 items-center rounded-lg hover:bg-gray-800" @click="remove('standard')" v-if="standard">
        ...
        <button class="flex bg-gray-900 p-2 px-4 ml-4 h-10 items-center rounded-lg hover:bg-gray-800" @click="add('foil')" v-if="view != 'list'">
        ...
        <button class="flex bg-gray-900 p-2 px-4 ml-4 h-10 items-center rounded-lg hover:bg-gray-800" @click="remove('foil')" v-if="foil && view != 'list'">
