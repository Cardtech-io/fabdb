    ...
    <div class="text-base pb-4">
        <form @submit.prevent="newSearch">
            <div class="flex w-full px-4 md:px-0">
                <div class="w-3/4 relative pr-1 flex bg-gray-200 focus:bg-white focus:border-gray-500 rounded-lg mr-2">
                    ...
                    <button type="button" class="absolute right-0 mt-1.5 text-black hover:text-gray-600 mr-1" @click.prevent="showAdvancedSearch">
                        <icon :size="7">
