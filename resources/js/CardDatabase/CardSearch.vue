        ...
        <form @submit.prevent="newSearch">
            <div class="flex w-full px-4 md:px-0">
                <div class="w-3/4 sm:w-4/5 relative pr-1 flex bg-gray-200 dark:bg-gray-900 focus:bg-gray-700 focus:border-gray-500 rounded-lg mr-2 items-center">
                    ...
                    <input type="text" v-model="params.keywords" class="flex-1 bg-transparent outline-none py-2 dark:text-gray-300" placeholder="Search..." :class="keywordClasses">
                    <button type="button" class="absolute right-0 text-black dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-100 mr-1" @click.prevent="showAdvancedSearch">
                        <icon :size="7">
