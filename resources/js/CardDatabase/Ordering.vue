<template>
    <div class="relative font-serif">
        <button class="relative flex items-center text-left border border-gray-200 text-base font-serif rounded-lg p-1 uppercase hover:bg-white hover:border-gray-500" @click="isOpen = !isOpen" :class="{ 'border-gray-500': isOpen, 'bg-white': isOpen, 'bg-gray-200': !isOpen, 'z-75': isOpen }">
        ...
        <div class="w-full absolute right-0 rounded-lg bg-white z-100 overflow-hidden mt-2 border border-gray-500" v-if="isOpen" style="width: 150px">
