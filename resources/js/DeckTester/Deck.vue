<template>
    <div class="w-200 relative">
        <img :src="cardBack" class="relative z-0 invisible">
        <img :src="cardBack" alt="" v-for="(n, i) in total" class="absolute rounded-card border border-gray-200 z-25" :style="position(i)">
        <div class="absolute z-50 w-full flex justify-center text-white text-center font-serif uppercase text-2xl top-2/3 mt-4">
