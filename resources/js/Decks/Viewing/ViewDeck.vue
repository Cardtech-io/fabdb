                    ...
                    <div class="md:flex md:pt-0">
                        ...
                        <div class="w-full md:w-3/4 md:py-4">
                            <ul class="flex border-b border-gray-400">
                                ...
                                <li class="ml-2">
                                    <button @click="copyToClipboard(shareDeckText(deck), 'Deck build copied to clipboard.')" class="sm:flex items-center w-full button-primary rounded-full px-4 py-2 text-sm" title="Copy deck to clipboard">
                                        <icon :size="4">
