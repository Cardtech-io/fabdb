    ...
    <div v-if="deck">
        <div v-if="deck.format === 'constructed'" class="flex items-center space-x-2">
            <div class="cursor-help group relative">
                <h2 class="font-serif uppercase border-b border-dotted border-gray-500"  :class="{ 'text-red-500': totalCards > maxCards }">{{totalMainDeck - 1 < 0 ? 0 : totalMainDeck - 1}}</h2>
            ...
            <span class="font-serif uppercase">/</span>
            <div class="cursor-help group relative">
                <h2 class="font-serif uppercase border-b border-dotted border-gray-500"  :class="{ 'text-red-500': totalCards > maxCards }">{{totalSideboard}}</h2>
            ...
            <span class="font-serif uppercase">/</span>
            <div class="cursor-help group relative">
                <h2 class="font-serif uppercase border-b border-dotted border-gray-500"  :class="{ 'text-red-500': totalCards > maxCards }">{{maxCards - 1}}</h2>
        ...
        <div v-if="deck.format === 'blitz'" class="flex items-center space-x-2">
            <div class="cursor-help group relative">
                <h2 class="font-serif uppercase border-b border-dotted border-gray-500"  :class="{ 'text-red-500': totalCards > maxCards }">{{totalMainDeck - 1}}</h2>
                <span class="tooltip transition-all delay-200 absolute block opacity-0 group-hover:opacity-100 bg-black text-white py-1 px-3 z-25 rounded text-xs mt-2 whitespace-nowrap">Main deck</span>
            </div>
            <span class="font-serif uppercase">/</span>
            <div class="cursor-help group relative">
